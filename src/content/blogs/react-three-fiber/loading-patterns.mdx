...
- Group assets together and display them when everything loaded (prevent waterfall effect).
...
<Callout type="info">
  `useDeferedValue` is an advanced React hook but is very easy to use in
...
This is a very basic example, but I think you can imagine how powerful this library really can be. It allows you to create complex loading screens, overlays, ... from anywhere within your `Canvas`.
